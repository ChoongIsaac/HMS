	...
	<section class="contact py-5">
		<div class="container">
			...
			<div class="mail_grid_w3l">
				<form action="application_form.php?id=<?php echo isset($_GET['id']) ? $_GET['id'] : '';?>" method="post">
						...
						<div class="col-md-6 contact_left_grid" data-aos="fade-right">
							...
							<div class="contact-fields-w3ls">
								<input type="text" name="roll_no" placeholder="Roll Number"
									value="<?php echo $_SESSION['roll'] ?>" required="" disabled="disabled">
							</div>
							<div class="contact-fields-w3ls">
	...
	<footer class="py-5">
		<div class="container py-md-5">
			<div class="footer-logo mb-5 text-center">
				<a class="navbar-brand" href="http://nitc.ac.in" target="_blank">NIT <span class="display">
						CALICUT</span></a>
			</div>
...
if (isset($_POST['submit'])) {
	...
	if (!preg_match('/^[A-Za-z0-9]+$/', $roll)) {
		...
		// ...
		// Your existing code for database operations or other logic
		// ...
